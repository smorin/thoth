# Product Requirements Document – Doxa Research v1.6
...
Usage: doxa-research "QUERY" [OPTIONS]
```
...
stevemorin@Steves-MacBook-Pro-3 doxa-research % ./doxa --help

Doxa Research - AI-Powered Research Assistant
Version 1.5.0

Usage:
  doxa-research [COMMAND] [OPTIONS]
  doxa-research [MODE] "QUERY" [OPTIONS]
  doxa-research "QUERY" [OPTIONS]
...
Quick Start:
  ...
  $ doxa deep_research "explain kubernetes networking"
...
For all options:
  $ doxa --help
stevemorin@Steves-MacBook-Pro-3 doxa-research %
