# Doxa Research v1.5 Implementation Plan - Version 1.2
...
- [x] **M1T-02**: Verify `doxa-research "test query"` creates output file ✅ *Works with --provider mock*
...
- [x] **M4T-06**: Verify `doxa-research "query"` uses default mode, not deep_research ✅ *Confirmed*
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "update", "--dry-run"],
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "update"],
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "clean", "--in-progress", "--dry-run"],
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "clean", "--days", "30", "--dry-run"],
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "clean", "--keep-recent", "5"],
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "list", "--in-progress"],
...
TestCase(
    ...
    command=[DOXA_EXECUTABLE, "list", "--completed"],
