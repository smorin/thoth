# Product Requirements Document – Doxa Research v2.3
...
| F-108 | Show list of available providers with cache status when `doxa-research providers -- --list` is run | Must | T-PROV-13 |
...
| F-118 | Store model cache in ~/.doxa-research/model_cache/ directory | Must | T-CACHE-06 |
...
doxa -i                         # Enter interactive query mode
...
Examples:
  ...
  $ doxa "query" --api-key-openai "your-key-here" --provider openai

  # Set multiple API keys for multi-provider modes
  $ doxa deep_research "query" --api-key-openai "sk-..." --api-key-perplexity "pplx-..."
