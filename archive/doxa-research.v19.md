# Product Requirements Document – Doxa Research v1.9
...
| Term | Definition |
|------|------------|
| Default mode | When no mode is specified, uses a special 'default' mode that passes queries directly to the LLM without any system prompt. NOTE: Quick mode (`doxa-research "query"`) uses "default" mode, NOT "deep_research" |
