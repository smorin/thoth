...
Doxa Research is a single‑file Python command‑line tool that automates deep research using large‑language‑model agents.
Key features:
	...
	•	Persistent defaults (e.g., favourite project) stored in ~/.doxa-research/defaults.toml.
...
13.1 ~/.doxa-research/models.toml
...
13.3 ~/.doxa-research/defaults.toml
