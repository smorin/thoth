...
This document identifies features present in the implementation plan (doxa-research.plan.v4.md) that are not documented in the PRD v2.0 (doxa-research.v20.md), along with recommendations for inclusion.
