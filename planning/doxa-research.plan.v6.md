...
Run: `uv run python -c "from tests.conftest import doxa_vcr, CASSETTE_DIR; print(CASSETTE_DIR)"`
Expected: prints the absolute path to `doxa_test_cassettes/`.
...
- [ ] All existing doxa_test tests still pass
...
- [ ] **Step 3: Run make test-check on doxa_test**

Run: `make test-check`
Expected: No lint/typecheck errors in doxa_test.
