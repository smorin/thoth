...
- [x] Regression test status after BUG-001 remediation: `uv run pytest -q` 1048/1048 green with 16 deselected; `./thoth_test -r --skip-interactive -q` 85/85 green with 1 skipped; `just check`, `just test-lint`, `just test-typecheck`, and `uv run ruff format --check src/ tests/` all pass.
