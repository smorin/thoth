...
- [x] [P33-T04] Refactor `ConfigSchema.get_defaults()` body to `_ROOT_SCHEMA.model_dump(mode="python")`. Verify byte-identical output against the historical snapshot. (TS01 still passes; full test suite still passes.)
