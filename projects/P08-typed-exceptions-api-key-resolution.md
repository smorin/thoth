...
**Out of Scope**
- Decomposing src/doxa_research/__main__.py (R01, separate future project)
...
- [x] [P08-T04] Add module-level `_map_openai_error(exc, model=None, verbose=False) -> DoxaError`
...
- [x] [P08-TS18] doxa_test: perplexity with empty PERPLEXITY_API_KEY fails with APIKeyError matching `r"perplexity API key not found"`
...
- `./doxa_test -r` passes with no regressions vs. P06 baseline (124 passed, 1 skipped) plus one new perplexity empty-key case
...
- [ ] doxa_test MOCK-01, MOCK-02, M2T-01, M2T-08 still pass
- [ ] doxa_test OAI-BG-01..14 still pass (check_status unchanged)
