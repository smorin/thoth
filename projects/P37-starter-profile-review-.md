...
### Notes
Predecessor: [P33 — Schema-Driven Config Defaults](P33-schema-driven-config-defaults.md). P33 made changing the *content* of starter profiles a one-line edit in `src/doxa_research/_starter_data.py::STARTER_PROFILES`, so this project is purely a UX/content review — not a refactor.
