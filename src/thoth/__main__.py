...
# time / threading re-exported for test_imports.py backstop (some tests
# reference thoth_main.time for monkeypatching even though this module
# no longer calls time.* directly).
...
# ============================================================================
from thoth.errors import (  # noqa: E402, F401
    APIKeyError,
    APIQuotaError,
    DiskSpaceError,
    ProviderError,
...
# Provider registry, factory, and API-key resolver live in thoth.providers.
# Re-exported here for back-compat with existing imports in tests/ and thoth_test.
from thoth.providers import (  # noqa: E402, F401
    PROVIDER_ENV_VARS,
    PROVIDERS,
    MockProvider,
    OpenAIProvider,
...
from thoth.providers.openai import _map_openai_error  # noqa: E402, F401
from thoth.signals import (  # noqa: E402, F401
...
# ============================================================================
# SECTIONS 12 & 13: PROVIDER ARCHITECTURE + REGISTRY
# ============================================================================
# All provider classes (ResearchProvider, MockProvider, OpenAIProvider,
# PerplexityProvider) and the factory (PROVIDERS, create_provider,
# resolve_api_key, _map_openai_error) live in the thoth.providers package.
# Re-exported via the `from thoth.providers import ...` block near the top.
# ============================================================================
