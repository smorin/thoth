...
from doxa_research.cli import _config_default_mode
from doxa_research.config import ConfigManager
from doxa_research.config_cmd import get_config_profile_add_data, get_modes_set_default_data
...
def test_resolution_env_beats_profile(
    ...
    get_config_profile_add_data("work", project=False, config_path=None)
    get_modes_set_default_data("quick_research", project=False, profile="work", config_path=None)
    monkeypatch.setenv("DOXA_DEFAULT_MODE", "thinking")
